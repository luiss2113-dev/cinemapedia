...
Este proyecto sigue la licencia descrita en el LICENSE.md [enlace al documento](LICENSE.md)

## Acuerdos de software (obligatorio)
Este proyecto esta basado en el siguiente código de conducta([enlace](CODE_OF_CONDUCT.md)) y contamos con las siguiente convenciones 
de código ([enlace](add_here)) las pruebas de software deben seguir la siguiente convención 
([enlace](add_here)). En este proyecto manejamos el siguiente estándar para el manejo de ramas ([enlace](add_here))
también manejamos el siguiente estándar de commits ([enlace](./.gitmessage.conf)). Para realizar un PR exitoso consideramos que debes seguir los siguientes pasos (enlace).
Para escribir documentación de nuevas carácteristicas o cambios en alguna de ellas debemos seguir el siguiente estándar de documentación ([enlace](https://github.com/weincoder/flutter-cicd-rm/wiki/Est%C3%A1ndar-de-PR)).
